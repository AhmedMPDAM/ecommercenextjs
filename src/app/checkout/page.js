...
export default function CheckoutPage() {
  ...
  const validateExpiryDate = (value) => {
    ...
    const inputDate = new Date(2000 + year, month - 1); // Month is 0-based
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center space-x-4">
              <div className="flex items-center">
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-full font-bold transition-all duration-300 ${
                    currentStep >= 1 ? 'bg-primary-600 text-white shadow-lg' : 'bg-gray-200 text-gray-500'
                  }`}
                >
              ...
              <div className={`w-16 h-1 rounded ${currentStep >= 2 ? 'bg-primary-600' : 'bg-gray-200'}`}></div>
              <div className="flex items-center">
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-full font-bold transition-all duration-300 ${
                    currentStep >= 2 ? 'bg-primary-600 text-white shadow-lg' : 'bg-gray-200 text-gray-500'
                  }`}
                >
              ...
              <div className={`w-16 h-1 rounded ${currentStep >= 3 ? 'bg-primary-600' : 'bg-gray-200'}`}></div>
              <div className="flex items-center">
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-full font-bold transition-all duration-300 ${
                    currentStep >= 3 ? 'bg-primary-600 text-white shadow-lg' : 'bg-gray-200 text-gray-500'
                  }`}
                >
                  3
                </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
                        ...
                        <div>
                          ...
                          <input
                            ...
                            {...register('zipCode', {
                              ...
                              pattern: {
                                value: /^[0-9]{4}$/,
                                message: 'Exactly 4 digits required',
                              },
                            })}
                            className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
                      ...
                      <div>
                        ...
                        <input
                          ...
                          {...register('cardNumber', {
                            ...
                            pattern: {
                              value: /^[0-9]{16}$/,
                              message: 'Exactly 16 digits required',
                            },
                          })}
                          className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
                        ...
                        <div>
                          ...
                          <input
                            ...
                            {...register('cvv', {
                              ...
                              pattern: {
                                value: /^[0-9]{3}$/,
                                message: 'Exactly 3 digits required',
                              },
                            })}
                            className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
